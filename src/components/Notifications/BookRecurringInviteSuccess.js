  ...
  return (
    ...
    >
      <Modal.Body>
        ...
        <p>Events will be created on your Google Calendar to mark this weekly booking. An email has been sent to every other person inviting them to the meeting.</p>
      </Modal.Body>
      <Modal.Footer>
